...
@section('title')
    {{ env('APP_NAME') }} || Introduction Section
@endsection
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div id="validation" class="mb-4">
                                        <h2 class="h3 mb-1">Introduction Section Content</h2>
                                        <p>
                                    ...
                                    <div class="mb-10 card">
                                        ...
                                        <div class="tab-content p-4" id="pills-tabContent-validation">
                                            ...
                                            <form class="row g-3 needs-validation" id="myForm"
                                                action="{{ route('v1.introduction.store') }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-md-12">
                                                    <label for="mail_mailer" class="form-label">Introduction</label>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12  d-none d-xl-block position-fixed end-0">
                        ...
                        <div class="sidebar-nav-fixed">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="#validation">Introduction Section</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('myForm').addEventListener('submit', function(e) {
                var editorContentElement = document.querySelector('#editor .ql-editor');
                var editorContent = editorContentElement ? editorContentElement.innerHTML : '';
