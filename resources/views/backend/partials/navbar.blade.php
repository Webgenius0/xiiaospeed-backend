    ...
    <div class="navbar-vertical navbar nav-dashboard">
        <div class="h-100" data-simplebar>
            ...
            <ul class="navbar-nav flex-column" id="sideNavbar">
                    ...
                    <a class="nav-link {{ Route::is('v1.project.*') ? 'active' : '' }}"
                        ...
                        <div style="margin-right: 8px">
                            <svg viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14px"
                                ...
                                fill="{{ Route::is('v1.project.*') ? '#624bff' : '#a3aab4' }}">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                ...
                {{-- comment --}}
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('v1.comment.*') ? 'active' : '' }}"
                        href="{{ route('v1.comment.index') }}">
                        <div style="margin-right: 8px">
                            <svg viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" width="14px"
                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" fill="{{ Route::is('v1.comment.*') ? '#624bff' : '#a3aab4' }}">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    ...
                                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                        ...
                                        <g id="Icon-Set" sketch:type="MSLayerGroup"
                                            transform="translate(-152.000000, -255.000000)" fill="{{ Route::is('v1.comment.*') ? '#624bff' : '#a3aab4' }}">
                                            <path
